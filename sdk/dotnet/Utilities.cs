...
namespace Cuemby.KubernetesXyz
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Cuemby.KubernetesXyz.version.txt");
    ...
    internal sealed class KubernetesXyzResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public KubernetesXyzResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
